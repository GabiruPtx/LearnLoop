    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iteration_unit', models.CharField(default='weeks', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cor', models.CharField(default='#808080', help_text='Cor em formato hexadecimal, ex: #FF0000', max_length=7)),
                ('ordem', models.PositiveIntegerField(default=0, help_text='Define a ordem de exibição da prioridade.')),
                ('projeto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prioridades', to='public.projeto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projeto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sprints', to='public.projeto')),
            ],
            options={
                'verbose_name': 'Sprint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100)),
                ('descricao', models.CharField(blank=True, help_text='Descrição opcional para a tag.', max_length=255, null=True)),
                ('cor', models.CharField(default='#d73a4a', help_text='Cor em formato hexadecimal, ex: #d73a4a', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(max_length=100)),
                ('descricao', models.TextField(blank=True, null=True)),
                ('cor', models.CharField(default='#808080', help_text='Cor em formato hexadecimal, ex: #FFFFFF', max_length=7)),
                ('ordem', models.PositiveIntegerField(default=0, help_text='Define a ordem de exibição do tamanho.')),
                ('projeto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tamanhos', to='public.projeto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(blank=True, null=True)),
                ('numero_tarefa_projeto', models.PositiveIntegerField(editable=False, help_text='Número sequencial da tarefa dentro do projeto.')),
                ...
                ('coluna', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tarefas', to='public.coluna')),
                ...
                ('prioridade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tarefas', to='public.prioridade')),
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='tarefas', to='public.tag')),
                ('tamanho', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tarefas', to='public.tamanho')),
            ],
            options={
                'verbose_name': 'Tarefa',
